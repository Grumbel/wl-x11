...
struct wlr_x11_present_window *wlr_x11_present_window_create(
	...
	uint32_t values[] = {
		...
		1, /* override_redirect */
		XCB_EVENT_MASK_EXPOSURE | XCB_EVENT_MASK_STRUCTURE_NOTIFY | XCB_EVENT_MASK_BUTTON_PRESS | XCB_EVENT_MASK_BUTTON_RELEASE | XCB_EVENT_MASK_POINTER_MOTION | XCB_EVENT_MASK_ENTER_WINDOW | XCB_EVENT_MASK_LEAVE_WINDOW,
		x11->colormap,
		XCB_CURSOR_NONE,
	};
